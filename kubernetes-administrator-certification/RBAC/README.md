...
The clusterrolebinding.yaml file contains the configuration for creating a cluster role binding named read-secrets-global. This cluster role binding binds the secret-reader cluster role to the user rajeshv globally.
...
### To check the permissions of the rajeshv user across all namespaces:

```
kubectl auth can-i get secret --as rajeshv -A
```
